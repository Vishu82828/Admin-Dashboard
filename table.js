...
//     `).join("");
//     document.getElementById("showdata").innerHTML = data;
//     removeButtonBackgroundColor(); // Moved this here to ensure it runs after the DOM update
// }
...
//         console.log("Success:", data);
//         alert("Successfully inserted!");
//         fetch_data(); // Call fetch_data here to refresh the table after insertion
//     })
//     .catch(error => {
//         console.error("Error:", error);
//         alert("Error, not inserted");
...
//         }
//         alert("Deleted");
//         fetch_data(); // Call fetch_data here to refresh the table after deletion
//     })
//     .catch(error => {
//         console.error('There was a problem with the fetch operation:', error);
//     });
